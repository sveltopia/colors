 ...
 */
import { generatePalette, getPaletteStats, BASELINE_HUES, RADIX_SCALES, RADIX_SCALES_DARK } from '../../dist/index.js';
...
export function generateHtml(options) {
    ...
    return buildHtml(palette, orderedHueKeys, hueDefs, title, RADIX_SCALES, RADIX_SCALES_DARK);
}
function buildHtml(palette, orderedHueKeys, hueDefs, title, radixScales, radixScalesDark) {
    return `<!DOCTYPE html>
<html>
<head>
  <title>${title}</title>
